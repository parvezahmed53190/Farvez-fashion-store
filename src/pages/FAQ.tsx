    ...
    <div className="max-w-4xl mx-auto px-4 py-24">
      ...
      <div className="mt-24 luxury-card p-12 text-center bg-gold/5 border-gold/20">
        ...
        <div className="flex flex-col md:flex-row justify-center gap-4">
          ...
          <a href="tel:+8801934996944" className="border border-gold text-gold px-8 py-3 font-bold rounded-sm hover:bg-gold hover:text-luxury-black transition-all">
            Call Support
          </a>
        </div>
      </div>
